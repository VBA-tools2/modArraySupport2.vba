...
Public Sub InitializeWorksheet4Tests( _
    ...
    With wks
        ...
        .Cells(16, 1).Value = "FirstNonEmptyStringIndexInVector"
        .Cells(17, 1).Value = "GetColumn"
        .Cells(18, 1).Value = "GetRow"
        .Cells(19, 1).Value = "InsertElementIntoVector"
        ...
        .Cells(34, 1).Value = "ReverseVectorInPlace"
        .Cells(35, 1).Value = "ReverseVectorOfObjectsInPlace"
